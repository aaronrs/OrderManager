...
public class CMSActivity extends Activity implements ContactsListFragment.OnContactsInteractionListener,
...
//        showNewOrder();
    ...
    public void saveOrder(View view) {
        String invoice = getEntryText(R.id.invoice);
        String product = getEntryText(R.id.productsDropdown);
        String batch = getEntryText(R.id.batch);
        String price = getEntryText(R.id.priceEditText);
        String quantity = getEntryText(R.id.quantityEditText);
        String deliveryDate = getEntryText(R.id.deliveryDate);
